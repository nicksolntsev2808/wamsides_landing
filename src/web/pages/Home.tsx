            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <a
                ...
                style={{
                  ...
                  fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "1.05rem",
                  color: "#FFFFFF", textDecoration: "none", transition: "background 0.2s",
                }}
              >
                ...
                Написати в Telegram — відповімо за 5 хв
              </a>
              <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                <div style={{ flex: 1, height: "1px", background: "#E8D5C0" }} />
                <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: "#9E7A65" }}>або залишіть телефон</span>
                <div style={{ flex: 1, height: "1px", background: "#E8D5C0" }} />
              </div>
              <form onSubmit={handleHeroSubmit} name="contact" data-netlify="true" netlify-honeypot="bot-field" style={{ display: "flex", gap: "0.75rem" }}>
